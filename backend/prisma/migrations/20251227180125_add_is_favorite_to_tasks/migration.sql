...
INSERT INTO "new_tasks" ("actual_hours", "archived_at", "archived_by", "assigned_to", "category_id", "client_id", "completed_at", "created_at", "created_by", "deadline", "description", "estimated_hours", "id", "is_archived", "priority", "status", "title", "updated_at", "updated_by", "visible_to_client") SELECT "actual_hours", "archived_at", "archived_by", "assigned_to", "category_id", "client_id", "completed_at", "created_at", "created_by", "deadline", "description", "estimated_hours", "id", "is_archived", "priority", "status", "title", "updated_at", "updated_by", "visible_to_client" FROM "tasks";
DROP TABLE "tasks";
