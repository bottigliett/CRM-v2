-- Import users from SQLite to MySQL
...
-- Insert user: davide
INSERT INTO users (
  username, email, email_verified, password, first_name, last_name, role, is_active,
  profile_image, last_login, theme, language, selected_theme, selected_tweakcn_theme,
  selected_radius, imported_theme_data, brand_colors, sidebar_variant, sidebar_collapsible,
  sidebar_side, created_at, updated_at
) VALUES (
  'davide',
  'marangonidavide05@gmail.com',
  1,
  '$2b$10$50F4nPy8vCUZTx3.suZZWOm23A02x9c6hr1O6Q4dKDZMmIByCrFKK',
  'Davide',
  'Marangoni',
  'SUPER_ADMIN',
  1,
