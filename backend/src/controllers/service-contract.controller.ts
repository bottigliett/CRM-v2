...
export const getServiceContracts = async (req: Request, res: Response) => {
  try {
    ...
    const contracts = await prisma.serviceContract.findMany({
      where,
      include: {
        organization: { select: { id: true, name: true, denomination: true, code: true, legalRep: true, shareholders: true, vatNumber: true, uniqueCode: true, pec: true, email: true, phone: true, billStreet: true, billCity: true, billState: true, billCode: true, billCountry: true } },
