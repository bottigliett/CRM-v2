...
import { Layout, Palette, RotateCcw, Settings, X, Shield } from 'lucide-react'
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
              <div className="py-2">
                <TabsList className="grid w-full grid-cols-3 rounded-none h-12 p-1.5">
                  ...
                  <TabsTrigger value="security" className="cursor-pointer data-[state=active]:bg-background"><Shield className="h-4 w-4 mr-1" /> PIN</TabsTrigger>
                </TabsList>
              </div>
